...
class BST{
	...
	private:
		...
		unsigned int findLCA(const T n1, const T n2, node* curr) {

				if (curr->data > n1 && curr->data > n2)
					return findLCA(n1, n2, curr->left);

				if (curr->data < n1 && curr->data < n2)
					return findLCA(n1, n2, curr->right);
	...
	public:
		...
		void findLCA (const T value1, const T value2) {

				std::cout << findLCA( value1, value2, root);
