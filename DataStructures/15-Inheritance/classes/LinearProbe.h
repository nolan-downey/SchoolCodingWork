...
class HashTable{
	...
	// Student change from private to protected
	protected:
		...
		// Add virtual keyword to base method
		virtual unsigned int findPos(const Key theKey) const{
	...
	public:
		...
		// Students write virtual constructor
		virtual ~HashTable() {}
