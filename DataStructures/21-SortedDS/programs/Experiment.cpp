...
int main(int argc, char** argv){
	...
	for(unsigned int test_iter = 0; test_iter < 100; ++test_iter){
	...
	// Print to a Comma Separated Value file (CSV
	std::cout << arrayLen << "," << totSDATime/100 << "," << totSLLTime/100 << "," << (totSLLTime/100)/(totSDATime/100) << std::endl;
