...
********************************************/
int recurCS(int nSteps, std::unordered_map<int, int>& stepVals){
	...
	int comb = recurCS(nSteps-1, stepVals) + recurCS(nSteps-2, stepVals) + recurCS(nSteps-3, stepVals);
...
int main(int argc, char** argv){
	...
	std::unordered_map<int, int> stepVals;
