...
int main() { 
  ...
  deleteAndPrint(str_tree, std::string("And"));
  deleteAndPrint(str_tree, std::string("our"));
  deleteAndPrint(str_tree, std::string("hearts"));
  deleteAndPrint(str_tree, std::string("forever,"));
  deleteAndPrint(str_tree, std::string("Love"));
  deleteAndPrint(str_tree, std::string("thee"));
  deleteAndPrint(str_tree, std::string("Notre"));
  deleteAndPrint(str_tree, std::string("Dame"));
